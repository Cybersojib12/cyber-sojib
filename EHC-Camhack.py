...
def logo():
    ...
    print("\033[94m│           \033[92mミ💖 CYBER SOJIB 💖彡\033[94m          │".center(columns+14))
    print("\033[94m│           \033[92mミ💖 CYBER SOJIB 💖彡\033[94m          │".center(columns+14))
    print("\033[94m│           \033[92mミ💖 CYBER SOJIB 💖彡\033[94m          │".center(columns+14))
    print("\033[94m│           \033[92ミ💖 CYBER SOJIB 💖彡 ▘\033[94m          │".center(columns+14))
    print("\033[94m│                              \033[94m          │".center(columns+8))
    print("\033[94m│ \033[95mAuthor : CYBER SOJIB.                \033[94m│".center(columns+14))
    print("│ \033[95mTool   : Hack With Link                \033[94m│".center(columns+8))
    print("│ \033[95mGitHub : https://github.com/Cybersojib12 \033[94m│".center(columns+8))
    print("│ \033[95mCoder  : CYBER SOJIB EHC          \033[37mV2.0  \033[94m│".center(columns+14))
    print("\033[94m└────────────────────────────────────────┘".center(columns+4))
...
def update():
    ...
    try:
        newVersion = json.loads(sb.getoutput("curl -s \"https://raw.githubusercontent.com/CYBER-SOJIB/Link-X/main/.version\"").replace("\n", "").strip())["version"]
    except:
    ...
    if not (oldVersion == newVersion):
        ...
        os.system("cd ../ && rm -rf Link-X && git clone https://github.com/Cybersojib12/Link-X > /dev/null 2>&1")
...
def printLocation(tmp):
    ...
    cPrint("\n    [cGreCYBER-SOJIB LongitudecGreen: cWhite" + data["lon"])
